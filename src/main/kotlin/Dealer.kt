...
class Dealer(private var name: String = "Dealer", private var finger: Int = 10) {
    ...
    fun printFirstHand() {
        println("A primeira carta é tal: ")
        println(this.hand.getCard(0))
        println("A segunda está virada, oq eu será que tem lá?")
    }
